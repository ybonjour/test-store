...
class TestWithResultsTest {
    companion object {
        ...
        val passedResultTest1 = Result(runId, "test1", 0, true, 20);
        val failedResultTest1 = Result(runId, "test1", 0, false, 20);
    }
    ...
    @Test fun retryPassedIsRetried() {
        val passedRetry = Result(failedResultTest1.run, failedResultTest1.testName, 1, true, 23);
        val testWithResults = TestWithResults(failedResultTest1.testName!!)
    ...
    @Test fun retryFailedIsFailed() {
        val failedRetry = Result(failedResultTest1.run, failedResultTest1.testName, 1, false, 23);
        val testWithResults = TestWithResults(failedResultTest1.testName!!)
